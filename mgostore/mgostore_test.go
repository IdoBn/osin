...
func initTestStorage() *OAuthStorage {
...
func deleteTestDatabase(storage *OAuthStorage) {
...
func setClient1234(storage *OAuthStorage) (osin.Client, error) {
...
func saveAccess(storage *OAuthStorage) (*osin.AccessData, error) {
